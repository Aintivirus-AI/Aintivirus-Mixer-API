...
export interface IWithdrawalVrifierInterface extends Interface {
...
export interface IWithdrawalVrifier extends BaseContract {
  connect(runner?: ContractRunner | null): IWithdrawalVrifier;
  waitForDeployment(): Promise<this>;

  interface: IWithdrawalVrifierInterface;
